...
import Metrology.Approxis.Soundness

/-!
# Approxis

Top-level re-export of the Approxis approximate relational verification framework.
Ported from `clutch/theories/approxis/approxis.v`.
-/
